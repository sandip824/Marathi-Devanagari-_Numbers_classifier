...
def model_prediction():
    ...
    print('test')
    canvas.create_text(220, 25, text= "मराठी  Alphabets Classifier",fill="#ff8000",font=('Helvetica 25 bold'))
    canvas.create_text(300, 60, text= "Model Prediction",fill="#00bfff",font=('Helvetica 20 bold'))
    canvas.create_text(300, 130, text= "अ ",fill="#00ff40",font=('Helvetica 100 bold'))
...
def get_model_prediction(preProcessedImage):
    classifier = load_model('models/marathi_swar_10_Epochs.h5')
...
def predict_button_clicked():
    ...
    canvas.create_text(100, 25, text= "मराठी  Alphabets Classifier",fill="#ff8000",font=('Helvetica 11 bold'))
